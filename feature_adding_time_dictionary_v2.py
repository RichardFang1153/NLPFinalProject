...
def extract_training_features(training_file, output_file):
    ...
    with open(output_file, "w") as output:
        for i in range(len(lines)):
            ...
            if token.lower() in ["morning", "afternoon", "noon", "evening", "night", "midnight", "Monday", "Tuesday", "Wedsnesday", "Thursday", "Friday", "Saturday", "Sunday", "January", "Faburary", "March", "April", "May", "June", "July", "August", "September", "October," "November", "December", "tomorrow", "today", "yesterday", "weekend", "week"]:
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python3 feature_adding.py <training_file> <test_file>")
        return
    ...
    with open("training.feature", "a") as train_feat:
        train_feat.write("\n")
    
    with open("test.feature", "a") as test_feat:
        test_feat.write("\n")
